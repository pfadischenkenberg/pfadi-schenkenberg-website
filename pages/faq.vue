<template>
  <div>
    <DefaultHero>Mögliche Fragen zur</DefaultHero>
    <main class="grid-container">
      <h1>Fragen, die auftauchen könnten</h1>
      <Accordion title="Was ist Pfadi?">
        <p>Die Pfadi ist die grösste Kinder- und Jugendorganisation der Schweiz und ermöglicht Kindern und Jugendlichen
          einmalige Erlebnisse in der Gruppe, unvergessliche Lagertage in der Natur und abenteuerliche Aktivitäten am
      ...
      <Accordion title="Was kostet mich die Pfadi?">
        ...
        <p>Wir versuchen die Kosten so tief wie möglich zu halten, um allen eine Teilnahme zu ermöglichen. Familien mit
          einem Familienpass PLUS oder der Kulturlegi erhalten eine Reduktion von 70% auf Jahres- und Lagerbeiträge.
          Meldet euch dafür bei der Abteilungsleitung. Auch Personen ohne diese Pässe dürfen sich bei finanziellen
          Engpässen gerne melden, um für alle eine Lösung zu finden.</p>
      </Accordion>
      ...
      <Accordion title="Welche Lager gibt es?">
        <p>Jedes Jahr findet im Frühling in 3-4 tägiges Pfingst- oder Auffahrtslager (PfiLa / AufLa) statt. Dieses
          verbringt die ganze Abteilung gemeinsam in Zelten in der Natur.</p>
        <p>Für die Pfadi und Pio Stufe gibt es ein zweiwöchiges Sommerlager in Zelten. Das «SoLa» findet meisten in den
          ersten zwei Sommerferienwochen statt.</p>
        <p>Für die Wolfsstufe gibt es dafür ein einwöchiges Herbstlager in einem gemütlichen Lagerhaus. Das «HeLa»
          findet in der ersten Herbstferienwoche statt.</p>
        <p>Unregelmässig finden auch Sommerlager für die ganze Abteilung oder grössere Lager mit unserem Bezirk
          Zytröseli, der Pfadi Region Basel oder der ganzen Pfadibewegung Schweiz statt. </p>
      </Accordion>
      <Accordion title="Wie sehe ich Fotos von Aktivitäten und Lagern?">
        <p>
        ...
        <p><a href="https://www.instagram.com/pfadi_schenkenberg/" target="_blank">Hier</a> geht es zu unserem Instagram
          Account</p>
      </Accordion>
      <Accordion title="Muss ich jeden Samstag in die Pfadi kommen?">
        <p>Es gibt keine Verpflichtung an die Aktivitäten zu kommen. Wenn du jedoch regelmässig in die Pfadi gehst, dann
          hast du auch mehr davon und du wirst dich schneller in der Gruppe wohlfühlen. Zudem macht Pfadi mehr Spass,
          wenn
          viele Pfadis mit dabei sind.</p>
        <p>Solltest du nicht an einen Anlass kommen kannst, bitten wir dich / deine Eltern, dich bei der Stufenleitung
          abzumelden.</p>
      </Accordion>
    </main>
  </div>
